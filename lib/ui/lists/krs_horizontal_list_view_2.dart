...
class KrsHorizontalListView2<T> extends StatefulWidget {
  ...
  @override
  State<KrsHorizontalListView2<T>> createState() => _KrsHorizontalListView2State<T>();
}

class _KrsHorizontalListView2State<T> extends State<KrsHorizontalListView2<T>> {
