...
class __$$_EmptyCopyWithImpl<T, $Res>
    extends _$RequestStateCopyWithImpl<T, $Res, _$_Empty<T>>
...
abstract class _Empty<T> extends RequestState<T> {
...
abstract class _Loading<T> extends RequestState<T> {
...
class __$$_SuccessCopyWithImpl<T, $Res>
    extends _$RequestStateCopyWithImpl<T, $Res, _$_Success<T>>
...
abstract class _Success<T> extends RequestState<T> {
...
abstract class _Error<T> extends RequestState<T> {
