...
FlmxItem _$FlmxItemFromJson(Map<String, dynamic> json) {
  return _FlmxItem.fromJson(json);
}
...
mixin _$FlmxItem {
  ...
  @JsonKey(ignore: true)
  $FlmxItemCopyWith<FlmxItem> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FlmxItemCopyWith<$Res> {
  factory $FlmxItemCopyWith(FlmxItem value, $Res Function(FlmxItem) then) =
      _$FlmxItemCopyWithImpl<$Res, FlmxItem>;
  @useResult
  $Res call(
      {@IntConverter() int id,
...
/// @nodoc
class _$FlmxItemCopyWithImpl<$Res, $Val extends FlmxItem>
    implements $FlmxItemCopyWith<$Res> {
  _$FlmxItemCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_FlmxItemCopyWith<$Res> implements $FlmxItemCopyWith<$Res> {
  factory _$$_FlmxItemCopyWith(
          _$_FlmxItem value, $Res Function(_$_FlmxItem) then) =
      __$$_FlmxItemCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@IntConverter() int id,
...
/// @nodoc
class __$$_FlmxItemCopyWithImpl<$Res>
    extends _$FlmxItemCopyWithImpl<$Res, _$_FlmxItem>
    implements _$$_FlmxItemCopyWith<$Res> {
  __$$_FlmxItemCopyWithImpl(
      _$_FlmxItem _value, $Res Function(_$_FlmxItem) _then)
      : super(_value, _then);
...
class _$_FlmxItem extends _FlmxItem {
  const _$_FlmxItem(
  ...
  factory _$_FlmxItem.fromJson(Map<String, dynamic> json) =>
      _$$_FlmxItemFromJson(json);
  ...
  @override
  String toString() {
    return 'FlmxItem(id: $id, section: $section, year: $year, yearEnd: $yearEnd, duration: $duration, poster: $poster, title: $title, originalTitle: $originalTitle, dateAtom: $dateAtom, favorited: $favorited, watchLater: $watchLater, shortStory: $shortStory, rip: $rip, quality: $quality, categories: $categories, actors: $actors, directors: $directors, countries: $countries, kpRating: $kpRating, imdbRating: $imdbRating)';
  }
  ...
  _$$_FlmxItemCopyWith<_$_FlmxItem> get copyWith =>
      __$$_FlmxItemCopyWithImpl<_$_FlmxItem>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_FlmxItemToJson(
      this,
    );
  }
}

abstract class _FlmxItem extends FlmxItem {
  const factory _FlmxItem(
      ...
      @DoubleConverter() final double imdbRating}) = _$_FlmxItem;
