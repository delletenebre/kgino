...
class TskgEpisodesPage extends StatefulWidget {
  final KginoItem kginoItem;

  const TskgEpisodesPage(this.kginoItem,{
    super.key,
  });

  @override
  State<TskgEpisodesPage> createState() => _TskgEpisodesPageState();
}

class _TskgEpisodesPageState extends State<TskgEpisodesPage> {
