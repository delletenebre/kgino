...
class Seasons extends _$Seasons {
  @override
  Future<List<MediaItemSeason>> build(MediaItem mediaItem) async {
    return fetch();
  }

  Future<List<MediaItemSeason>> fetch() async {
    return await mediaItem.loadSeasons(ref);
  }
}
...
class PlaylistPage extends HookConsumerWidget {
  ...
  Widget build(context, ref) {
    ...
    final details = ref.watch(seasonsProvider(mediaItem));
                                    ...
                                    onFocusChange: (hasFocus) {
                                      if (hasFocus) {
                                        ...
                                        if (selectedEpisodeIndex.value <
                                          ...
                                          episodesListObserverController
                                              .animateTo(
                                            index: minIndex,
                                            isFixedHeight: true,
                                            offset: (offset) => 0.0,
